...
function getSpiralcost(){
    if (no_of_pages<=50){
        return 25;
    }else if(no_of_pages<=100){
        return 35;
    }else if(no_of_pages<=150){
        return 45;
    }else{
        return 55;
    }
...
function getPrice(){
    if (sides.value == 1 && print_colour.value == 0){
        return (getPapers()*1.25+getSpiralcost())*copies.value;
    }
    if (sides.value==2 && print_colour.value == 0){
        return (getPapers()*1.5+getSpiralcost())*copies.value;
    }
    if (sides.value == 1 && print_colour.value == 1){
        return (getPapers()*10+getSpiralcost())*copies.value;
    }
}
